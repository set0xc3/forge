...
FR_API Vector2i v2i(i32 x, i32 y);
FR_API Vector3i v3i(i32 x, i32 y, i32 z);
FR_API Vector4i v4i(i32 x, i32 y, i32 z, i32 w);

FR_API Vector2f v2f(f32 x, f32 y);
FR_API Vector3f v3f(f32 x, f32 y, f32 z);
FR_API Vector4f v4f(f32 x, f32 y, f32 z, f32 w);
